...
<div id="page-content" class="col-12 col-md-10 col-lg-8 col-xl-6 p-3 justify-center">
	...
	<h4> What different abilities do teacher, administrator, and institution accounts have? </h4>
	<p> An institution account is an “umbrella” account made so that administrators and teachers can be affiliated with an institution. Administrators handle the transactions (requests/listings) and teachers have the ability to make suggested requests and listings. All accounts have the ability to browse the requests and listings on the platform. </p>
