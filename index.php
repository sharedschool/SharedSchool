	...
	<div class="container-fluid">
		...
		<div class="row justify-content-center">
			<div class="col-md-4 deadCenter text">
				<img class="img-fluid" src="/img/hp_graphic.png" width="450">
			</div>
		...
		<div class="row justify-content-center gray">
			<div class="col-md-10 text faq_qs">
				...
				<h4 align = "center"> More Questions? Click <a href = "/faq.html">here</a> to see our full FAQ page </h4>				
			</div>
		</div>
		...
		<div class="row justify-content-center">
			<div class="col-md-10 text">
				...
				<p align="center">If you have any questions or would like to request a demo, please contact us at <b><a href="mailto:sharedschool1@gmail.com" class="email">sharedschool1@gmail.com</a></b>.</p>
			</div>
		</div>
